...
export const suggestedQuestions: SuggestedQuestion[] = [
  {
    ...
    answer:
      'Dat is a Developer at Permate Global (since August 2023), working on the Permate affiliate marketing platform with Vue, Nuxt, and Flutter — focused on UI/UX, APIs, and team collaboration.',
    sort_order: 1,
  },
  {
    id: 'q2',
  ...
  },
  {
    ...
    answer:
      'He works primarily with HTML, CSS, JavaScript, TypeScript, Vue.js, React, Nuxt.js, and Next.js. He also has exposure to React Native, Flutter, Spring Boot, and REST APIs.',
    sort_order: 3,
  },
  {
    id: 'q4',
